		...
		<div class="hit_content">
			<div class="hit_content_wrap">
						...
						<form method="post" id="qnaInsert">
							<div class="contact">
								<div class="text-block-37">
									<span class="text-span-2">*</span> 분류
								</div>
								<select name="category" id="category" class="select-field w-select">
							...
							<div class="contact">
								<div class="text-block-37">
									<span class="text-span-2">*</span> 제목
								</div>
								<input type="text" class="text-field w-input" maxlength="100" name="title" placeholder="제목">
							</div>
							<div class="contact _1">
								<div class="text-block-37">
									<span class="text-span-2">*</span> 내용
								</div>
								<div class="div-block-14">
									<textarea placeholder="Example Text" maxlength="2000" class="textarea w-input" name="text"></textarea>
									<div class="text-block-32 _1">- 내용은 2000자 까지 입력이 가능합니다</div>
									<div class="text-block-34">- 이용에 제한이 따를 수 있으니 욕설 비방 허위사실 등을 삼가주시기 바랍니다.</div>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="div-block-15">
					...
					<a href="javascript:qnaInsert()" id="qnaBtn" class="button-2-copy _1 w-button">등록하기</a>
				</div>
			</div>
		</div>
...
<script>
function qnaInsert() {
	$("#qnaBtn").attr("href","javascript:void(0)");
	var data = $("#qnaInsert").serialize();
	$.ajax({
		type : 'post',
		data : data,
		url : '/klottery/user/qnaInsertProcess.do',
		success : function(data) {
			alert(data.msg);
			if (data.result == "success") {
				location.href = '/klottery/user/qnaList.do';
			}
			$("#qnaBtn").attr("href","javascript:qnaInsert()");
		}
	})
}
</script>
