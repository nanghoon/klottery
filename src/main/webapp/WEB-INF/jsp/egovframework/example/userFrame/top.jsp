...
<div class="top">
	<div class="topbar">
		<div class="topwrap-2">
			<a href="#" class="m_logobtn w-inline-block">
				...
				sizes="(max-width: 479px) 41vw, (max-width: 767px) 93px, 100vw" alt="" class="m_logo">
			</a>
			...
			<div class="m_menuframe">
				<div class="m_menubox">
					<div class="m_box">
						<a href="#" class="closebtn w-inline-block">
							<img src="/klottery/webflow/images/remove_x_icon_1remove_x_icon.png" loading="lazy" alt="" class="closeicon _2">
						</a>
					</div>
		...
		<div class="topwrap_login">
			<div class="m_top">
				<a href="#" class="m_logobtn w-inline-block">
					<img src="/klottery/webflow/images/logo.png" loading="lazy" width="93"
					srcset="/klottery/webflow/images/k-lottery로고-p-500.png 500w, /klottery/webflow/images/k-lottery로고-p-800.png 800w, /klottery/webflow/images/k-lottery로고-p-1080.png 1080w, /klottery/webflow/images/k-lottery로고-p-1600.png 1600w, /klottery/webflow/images/k-lottery로고-p-2000.png 2000w, /klottery/webflow/images/logo.png 2068w"
					sizes="100vw" alt="" class="m_logo">
				</a>
				<div class="m_menuwrap">
					<div class="div-block-37 m">
						<img src="/klottery/webflow/images/4213460_account_avatar_head_person_profile_icon_14213460_account_avatar_head_person_profile_icon.png" loading="lazy" alt="" class="user">
					</div>
					<a href="#" class="m_menubtn w-inline-block">
						<img src="/klottery/webflow/images/menu_icon-2_1menu_icon-2.png" loading="lazy" alt="" class="m_menuicon">
					</a>
